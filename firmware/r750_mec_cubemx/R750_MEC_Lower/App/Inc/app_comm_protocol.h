...
typedef enum {
  ...
  APP_COMM_COMMAND_SPEED_CAPTURE_START,
  APP_COMM_COMMAND_SPEED_CAPTURE_STOP,
  APP_COMM_COMMAND_SPEED_CAPTURE_EXPORT,
  APP_COMM_COMMAND_SPEED_CAPTURE_STATUS,
  APP_COMM_COMMAND_IMU_CAPTURE_START,
  APP_COMM_COMMAND_IMU_CAPTURE_STOP,
  APP_COMM_COMMAND_IMU_CAPTURE_EXPORT,
  APP_COMM_COMMAND_IMU_CAPTURE_STATUS
} AppCommCommandType;
