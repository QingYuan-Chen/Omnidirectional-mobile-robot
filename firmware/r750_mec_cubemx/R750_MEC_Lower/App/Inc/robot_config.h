...
/* 高速导出最多占用三个槽位，始终为分类型诊断遥测保留一个发送槽位。 */
#define ROBOT_CONFIG_UART_TX_CAPTURE_RESERVED_SLOTS (1U)
...
#define ROBOT_CONFIG_G3_SPEED_TIMER_IRQ_PRIORITY  (6U)
...
#define ROBOT_CONFIG_SPEED_CAPTURE_CAPACITY       (2200U)
#define ROBOT_CONFIG_IMU_CAPTURE_CAPACITY         (1700U)
...
/* schema 1 分类型诊断：STAT 20 Hz、IMUQ 10 Hz、RES 2 Hz，EVENT 最多 10 Hz。 */
#define ROBOT_CONFIG_TELEMETRY_PERIOD_MS          (50U)
#define ROBOT_CONFIG_IMUQ_TELEMETRY_PERIOD_MS     (100U)
#define ROBOT_CONFIG_RES_TELEMETRY_PERIOD_MS      (500U)
#define ROBOT_CONFIG_EVENT_TELEMETRY_MIN_PERIOD_MS (100U)
